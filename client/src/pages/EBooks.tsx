    ...
    <div className="p-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-2xl font-bold text-gray-900" data-testid="text-ebooks-title">My eBooks</h2>
        ...
        <Card className="shadow-material">
          <CardContent className="p-8 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2" data-testid="text-empty-title">No eBooks Yet</h3>
            <p className="text-gray-600 mb-6" data-testid="text-empty-description">
              This screen is not implemented yet. Future features will include eBook creation, management, and organization.
            </p>
            <div className="bg-gray-50 rounded-lg p-4 text-left">
              ...
              <ul className="text-sm text-gray-600 space-y-1">
                ...
                <li>• Categorize by genres</li>
                <li>• Share eBooks with others</li>
              </ul>
            </div>
          </CardContent>
        </Card>
