                ...
                <Form {...form}>
                  <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                        ...
                        <FormItem>
                          <FormControl>
                            <Input
                              ...
                              className="h-14 border border-gray-200 rounded-xl focus:border-blue-500 focus:ring-0 text-gray-900 placeholder:text-gray-500"
                    ...
                    >
                      ...
                      {isGoogleLoading ? 'Criando conta...' : 'Continuar com Google'}
                    </Button>
                  </form>
                </Form>
              </div>
